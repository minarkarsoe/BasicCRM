...
namespace Recsite_Ats.Infrastructure.Migrations
{
    ...
    [Migration("20241107073700_Initial")]
            ...
            modelBuilder.Entity("Recsite_Ats.Domain.Entites.Account", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = 0,
                            CreatedDate = new DateTime(2024, 11, 7, 14, 36, 59, 499, DateTimeKind.Local).AddTicks(8073),
                            EditedBy = 0,
                            EditedDate = new DateTime(2024, 11, 7, 14, 36, 59, 499, DateTimeKind.Local).AddTicks(8075),
                            PrimaryCountry = "UK",
                            SeatId = 1
                        });
                });
            ...
            modelBuilder.Entity("Recsite_Ats.Domain.Entites.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            AccountId = 1,
                            ConcurrencyStamp = "73ded9e2-f34b-41fc-9c58-0ab1efaf739a",
                            CreatedBy = 0,
                            CreatedDate = new DateTime(2024, 11, 7, 14, 36, 59, 499, DateTimeKind.Local).AddTicks(8177),
                            EditedDate = new DateTime(2024, 11, 7, 14, 36, 59, 499, DateTimeKind.Local).AddTicks(8178),
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEAv0FLcAn5BU5TuX4+xbXNfPT6IfbrdOu5dUyZi+bpnbSloqVGdcv0ln2WDUiZj1zg==",
            ...
            modelBuilder.Entity("Recsite_Ats.Domain.Entites.Seat", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            SeatRenewelDate = new DateTime(2024, 11, 7, 14, 36, 59, 499, DateTimeKind.Local).AddTicks(8016),
                            TotalSeats = 10,
                            UsedSeats = 0
                        });
                });
