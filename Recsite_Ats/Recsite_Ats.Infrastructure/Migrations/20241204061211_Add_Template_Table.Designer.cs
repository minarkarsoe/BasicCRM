...
namespace Recsite_Ats.Infrastructure.Migrations
{
    ...
    [Migration("20241204061211_Add_Template_Table")]
            ...
            modelBuilder.Entity("Recsite_Ats.Domain.Entites.Account", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = 0,
                            CreatedDate = new DateTime(2024, 12, 4, 13, 12, 10, 505, DateTimeKind.Local).AddTicks(555),
                            EditedBy = 0,
                            EditedDate = new DateTime(2024, 12, 4, 13, 12, 10, 505, DateTimeKind.Local).AddTicks(556),
                            PrimaryCountry = "UK",
                            SeatId = 1
                        });
                });
            ...
            modelBuilder.Entity("Recsite_Ats.Domain.Entites.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            AccountId = 1,
                            ConcurrencyStamp = "9563abb8-905e-4ff9-b375-f71a11aaf508",
                            CreatedBy = 0,
                            CreatedDate = new DateTime(2024, 12, 4, 13, 12, 10, 505, DateTimeKind.Local).AddTicks(686),
                            EditedDate = new DateTime(2024, 12, 4, 13, 12, 10, 505, DateTimeKind.Local).AddTicks(687),
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEKMIoL54JyZdk4iw5dGzfAckJNtIxGYg39OTstHCh0h+cEc3pwhJhV4Jrz6ek9mWTQ==",
            ...
            modelBuilder.Entity("Recsite_Ats.Domain.Entites.Seat", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            SeatRenewelDate = new DateTime(2024, 12, 4, 13, 12, 10, 505, DateTimeKind.Local).AddTicks(533),
                            TotalSeats = 10,
                            UsedSeats = 0
                        });
                });
