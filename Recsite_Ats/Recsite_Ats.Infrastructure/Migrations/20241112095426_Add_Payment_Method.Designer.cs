...
namespace Recsite_Ats.Infrastructure.Migrations
{
    ...
    [Migration("20241112095426_Add_Payment_Method")]
            ...
            modelBuilder.Entity("Recsite_Ats.Domain.Entites.Account", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = 0,
                            CreatedDate = new DateTime(2024, 11, 12, 16, 54, 26, 302, DateTimeKind.Local).AddTicks(785),
                            EditedBy = 0,
                            EditedDate = new DateTime(2024, 11, 12, 16, 54, 26, 302, DateTimeKind.Local).AddTicks(786),
                            PrimaryCountry = "UK",
                            SeatId = 1
                        });
                });
            ...
            modelBuilder.Entity("Recsite_Ats.Domain.Entites.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            AccountId = 1,
                            ConcurrencyStamp = "e4d2de92-bf28-4bf1-9ff4-2433b0ee37fa",
                            CreatedBy = 0,
                            CreatedDate = new DateTime(2024, 11, 12, 16, 54, 26, 302, DateTimeKind.Local).AddTicks(888),
                            EditedDate = new DateTime(2024, 11, 12, 16, 54, 26, 302, DateTimeKind.Local).AddTicks(889),
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEBxyns81hrLo1IkArnCeh4DmRSxDxTBKf1ETbx3BPuvaejB9QVA0aF+aqbhq1wO8Fw==",
            ...
            modelBuilder.Entity("Recsite_Ats.Domain.Entites.Seat", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            SeatRenewelDate = new DateTime(2024, 11, 12, 16, 54, 26, 302, DateTimeKind.Local).AddTicks(773),
                            TotalSeats = 10,
                            UsedSeats = 0
                        });
                });
