...
namespace Recsite_Ats.Infrastructure.Migrations
{
    ...
    [Migration("20241209024555_Fix_Mailgun_Setting_Table")]
    partial class Fix_Mailgun_Setting_Table
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Recsite_Ats.Domain.Entites.Account", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = 0,
                            CreatedDate = new DateTime(2024, 12, 9, 9, 45, 54, 230, DateTimeKind.Local).AddTicks(5949),
                            EditedBy = 0,
                            EditedDate = new DateTime(2024, 12, 9, 9, 45, 54, 230, DateTimeKind.Local).AddTicks(5950),
                            PrimaryCountry = "UK",
                            SeatId = 1
                        });
                });
            ...
            modelBuilder.Entity("Recsite_Ats.Domain.Entites.ApplicationModules", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Recsite_Ats.Domain.Entites.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            AccountId = 1,
                            ConcurrencyStamp = "ba26353b-18d5-4b5b-bfe1-a15fa2c3ef48",
                            CreatedBy = 0,
                            CreatedDate = new DateTime(2024, 12, 9, 9, 45, 54, 230, DateTimeKind.Local).AddTicks(6044),
                            EditedDate = new DateTime(2024, 12, 9, 9, 45, 54, 230, DateTimeKind.Local).AddTicks(6045),
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEO2/FoeOhs8MmkOUgeooue4k/dYSHTvzh+82Gyje+JSSG62zH17TDEsUXW1shQ8L5w==",
            ...
            modelBuilder.Entity("Recsite_Ats.Domain.Entites.BillingInformation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Recsite_Ats.Domain.Entites.CandidateSource", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Recsite_Ats.Domain.Entites.ContactStages", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Recsite_Ats.Domain.Entites.CountryData", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Recsite_Ats.Domain.Entites.DocumentType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Recsite_Ats.Domain.Entites.EmailTemplate", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Recsite_Ats.Domain.Entites.JobCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Recsite_Ats.Domain.Entites.JobLocation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Recsite_Ats.Domain.Entites.JobStatus", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Recsite_Ats.Domain.Entites.JobSubCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Recsite_Ats.Domain.Entites.JobSubLocation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Recsite_Ats.Domain.Entites.MailGunSetting", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Recsite_Ats.Domain.Entites.NoteType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Recsite_Ats.Domain.Entites.PaymentMethod", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Recsite_Ats.Domain.Entites.Seat", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            SeatRenewelDate = new DateTime(2024, 12, 9, 9, 45, 54, 230, DateTimeKind.Local).AddTicks(5935),
                            TotalSeats = 10,
                            UsedSeats = 0
                        });
                });
            ...
            modelBuilder.Entity("Recsite_Ats.Domain.Entites.JobSubCategory", b =>
                {
                    b.HasOne("Recsite_Ats.Domain.Entites.JobCategory", "JobCategory")
            ...
            modelBuilder.Entity("Recsite_Ats.Domain.Entites.JobSubLocation", b =>
                {
                    b.HasOne("Recsite_Ats.Domain.Entites.JobLocation", "JobLocation")
                        .WithMany("JobSubLocations")
