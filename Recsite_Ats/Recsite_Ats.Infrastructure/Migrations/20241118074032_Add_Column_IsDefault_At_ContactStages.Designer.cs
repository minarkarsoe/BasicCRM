...
namespace Recsite_Ats.Infrastructure.Migrations
{
    ...
    [Migration("20241118074032_Add_Column_IsDefault_At_ContactStages")]
    partial class Add_Column_IsDefault_At_ContactStages
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Recsite_Ats.Domain.Entites.Account", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = 0,
                            CreatedDate = new DateTime(2024, 11, 18, 14, 40, 31, 830, DateTimeKind.Local).AddTicks(9945),
                            EditedBy = 0,
                            EditedDate = new DateTime(2024, 11, 18, 14, 40, 31, 830, DateTimeKind.Local).AddTicks(9945),
                            PrimaryCountry = "UK",
                            SeatId = 1
                        });
                });
            ...
            modelBuilder.Entity("Recsite_Ats.Domain.Entites.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            AccountId = 1,
                            ConcurrencyStamp = "7ee10a3b-87f8-4aaf-a18f-8b3e6f50a64a",
                            CreatedBy = 0,
                            CreatedDate = new DateTime(2024, 11, 18, 14, 40, 31, 831, DateTimeKind.Local).AddTicks(43),
                            EditedDate = new DateTime(2024, 11, 18, 14, 40, 31, 831, DateTimeKind.Local).AddTicks(44),
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEMSULSVuTTW2a5LqZL/Yc/X+iN++0827Oo//6IoramccpoKnm6LvDcRMK3NyvD2nZw==",
            ...
            modelBuilder.Entity("Recsite_Ats.Domain.Entites.Seat", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            SeatRenewelDate = new DateTime(2024, 11, 18, 14, 40, 31, 830, DateTimeKind.Local).AddTicks(9933),
                            TotalSeats = 10,
                            UsedSeats = 0
                        });
                });
