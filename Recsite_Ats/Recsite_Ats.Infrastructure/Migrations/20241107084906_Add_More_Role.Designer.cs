...
namespace Recsite_Ats.Infrastructure.Migrations
{
    ...
    [Migration("20241107084906_Add_More_Role")]
    partial class Add_More_Role
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Recsite_Ats.Domain.Entites.Account", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = 0,
                            CreatedDate = new DateTime(2024, 11, 7, 15, 49, 5, 880, DateTimeKind.Local).AddTicks(3654),
                            EditedBy = 0,
                            EditedDate = new DateTime(2024, 11, 7, 15, 49, 5, 880, DateTimeKind.Local).AddTicks(3655),
                            PrimaryCountry = "UK",
                            SeatId = 1
                        });
                });
            ...
            modelBuilder.Entity("Recsite_Ats.Domain.Entites.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            AccountId = 1,
                            ConcurrencyStamp = "91de1c30-e3fc-46fd-bf31-b1236cd6a00b",
                            CreatedBy = 0,
                            CreatedDate = new DateTime(2024, 11, 7, 15, 49, 5, 880, DateTimeKind.Local).AddTicks(3766),
                            EditedDate = new DateTime(2024, 11, 7, 15, 49, 5, 880, DateTimeKind.Local).AddTicks(3767),
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEJfEnNoMrHXz66gjl8Vqzk4AUnRWTtFyzU3jRvXzvr0uixKkw4TY5KHK3CMnEkr37Q==",
            ...
            modelBuilder.Entity("Recsite_Ats.Domain.Entites.Seat", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            SeatRenewelDate = new DateTime(2024, 11, 7, 15, 49, 5, 880, DateTimeKind.Local).AddTicks(3638),
                            TotalSeats = 10,
                            UsedSeats = 0
                        });
                });
