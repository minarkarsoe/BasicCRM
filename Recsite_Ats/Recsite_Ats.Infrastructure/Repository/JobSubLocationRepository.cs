...
public class JobSubLocationRepository : Repository<JobSubLocation>, IJobSubLocationRepository
{
    private readonly ApplicationDbContext _db;
    public JobSubLocationRepository(ApplicationDbContext db) : base(db)
    {
        _db = db;
    }
}
