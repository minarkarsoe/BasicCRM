...
public class BillingInformationRepository : Repository<BillingInformation>, IBillingInformationRepository
{
    private readonly ApplicationDbContext _db;
    public BillingInformationRepository(ApplicationDbContext db) : base(db)
    {
        _db = db;
    }
}
