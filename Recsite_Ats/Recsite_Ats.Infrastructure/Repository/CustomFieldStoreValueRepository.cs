...
public class CustomFieldStoreValueRepository : Repository<StoreCustomFieldValue>, ICustomFieldStoreValue
{
    private readonly ApplicationDbContext _db;
    public CustomFieldStoreValueRepository(ApplicationDbContext db) : base(db)
    {
        _db = db;
    }
}
